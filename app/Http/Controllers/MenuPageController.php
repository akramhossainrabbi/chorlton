...
*/
    ...
    {
         return "Dear ".$name.", Thank you for table reservation at Chorlton, ".$sitename.". We have included your Reservation details below:";
    }
    ...
    )
    {
          ...
          try {
              ...
              $mail->SMTPAuth = true;
              $mail->Username = 'noreply@corianderrestaurants.co.uk';
              $mail->Password = 'Chorlton-924';
...
/*
              ...
              $mail->setFrom('noreply@corianderrestaurants.co.uk', $this->SiteName);
              //$mail->addReplyTo('noreply@bombaynite.com', 'No-Reply - Bombay Nite');
              //$mail->addAddress($to, 'Fahad Bhuyian');
              $mail->addAddress($to);               // Name is optionalz
              $mail->addAddress("munna.ak17@gmail.com");               // Name is optional
