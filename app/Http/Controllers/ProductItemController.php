    ...
    public function makePayment(Request $request)
    {
       ...
       if($request->payment_method=="Cash")
       {
        ...
        if($recType=="Collect"){
            ...
            else
            {
                ...
                $delivery->email,
                'Admin Order Receipt - '.$this->sdc->SiteName,
                $newHtmlStr,'chorlton@corianderrestaurants.co.uk');
            }
       ...
       // die();
        ...
        if($request->payment_method=="Cash")
        {
            ...
            // return redirect()->to('https://corianderrestaurants.co.uk/');
            return redirect('complete-payment')->with('status', 'ORDER SUBMITTED SUCCESSFULLY');
